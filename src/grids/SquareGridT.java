...
/*
 * Subclass of the Grid class. Implements getNeighbors method for the T neighborhood from http://golly.sourceforge.net/Help/Algorithms/QuickLife.html#nontotal
 */
public class SquareGridT extends Grid {

	public SquareGridT(CellOccupant[][] grid) {
		super(grid);
	}
