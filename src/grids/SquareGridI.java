...
/*
 * Subclass of the Grid class. Implements getNeighbors method for the I6 neighborhood from http://golly.sourceforge.net/Help/Algorithms/QuickLife.html#nontotal
 */
public class SquareGridI extends Grid {

	public SquareGridI(CellOccupant[][] grid) {
		super(grid);
	}
