...
/*
 * Subclass of the Grid class. Implements getNeighbors method for the Y5 neighborhood from http://golly.sourceforge.net/Help/Algorithms/QuickLife.html#nontotal.
 */
public class SquareGridY extends Grid {

	public SquareGridY(CellOccupant[][] grid) {
		super(grid);
	}
